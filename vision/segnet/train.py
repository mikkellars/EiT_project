...
from vision.segnet.dataset import *
...
def parse_arguments():
    ...
    parser.add_argument('--save_dir', type=str, default='vision/segnet/models', help='path to models directory')
...
def main(args):
    ...
    if args.resume_model != '':
        ...
        print(f'Loaded {args.resume_model}. The model is trained for {saved_model["epoch"]} epochs with {saved_model["loss"]} loss and {saved_model["acc"]} accuracy')
