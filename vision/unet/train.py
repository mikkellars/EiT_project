...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default='unet', help='name of the experiment')
    parser.add_argument('--data_dir', type=str, default='data/fence_data/train_set', help='path to data directory')
    parser.add_argument('--save_dir', type=str, default='unet/models', help='path to models directory')
